...
def draw_circles(t,size,repeat, impact):
    for _ in range(4):
        t.circle(size)
        size = size - impact
...
def draw_special (t, size, repeat, impact):
    for _ in range (repeat): 
        draw_circles(t, size, repeat,impact)
        t.right(360 / repeat)
...
def draw_picture_nice():
    ...
    for i in range (10):
        ...
        impact_affect = (loops[i % len(loops)])
        draw_special(t, 100, 10, impact_affect)
        print(impact_affect)
# def draw_picture():
#     t = turtle.Turtle()
#     t.speed(0)
#     t.color('yellow')
#     draw_special(t, 100, 10, 1)

#     Barry = turtle.Turtle()
#     Barry.speed(0)
#     Barry.color('blue')
#     draw_special(Barry, 100, 10, 1)
