...
# print(f'''Your trip starts on day {day_today} ({days_week[day_today]}),
...
# alex.pensize(5)
# alex.up()
# for rainaow_color in rainbow_colors:
#     alex.color(rainaow_color)
#     alex.goto(0, -radius) 
#     alex.down()
#     alex.circle(radius)
...
awesomecolors = ["indigo" , "cyan" , "pink" , "yellow" , "orange" , "green" , "red"]
...
alex.speed(5)
alex.pensize(12)
for hugerainbow in awesomecolors:
   alex.up()
   alex.goto(radius, 0)
   alex.down()
   alex.color(hugerainbow)
   radius1 = radius
   alex.circle(radius, 180)
   radius = radius + radius_increase
   alex.up()
