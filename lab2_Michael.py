...
division_result= dividend // divisor     # The quotient should be 3
remainder = dividend %  divisor    # The remainder should be 1

print(f"""
Exercise 2:
{dividend} ÷ {divisor} = {division_result}   (decimal result)
{dividend} ÷ {divisor} = {division_result} remainder {remainder}
""")
...
print("\nExercise 4")  
radius = 2 
circlesarea = (3.14 * radius * radius) 
print(f"the area of a circle with radius 2 is {circlesarea}")
...
day_today = (int(input("Enter todays day number")))
print(f"todays number is {day_today}")
days_trip = (int(input("Enter the trips duration in days")))
date_of_return = (day_today + days_trip) % 7
print(f"you will return on {date_of_return}")
realreturn = days_of_week[date_of_return]
print(f"that day is going to be {realreturn}")
print("just me playing around, this is really coool")
